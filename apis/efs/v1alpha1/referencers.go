...
// EFSFilesystemID returns the status.atProvider.fileSystemID of an Filesystem.
func EFSFilesystemID() reference.ExtractValueFn {
	return func(mg resource.Managed) string {
		r, ok := mg.(*FileSystem)
		if !ok {
			return ""
		}
		if r.Status.AtProvider.FileSystemID == nil {
			return ""
		}
		return *r.Status.AtProvider.FileSystemID
	}
}
