...
type external struct {
	...
	postDelete     func(context.Context, *svcapitypes.Job, *svcsdk.DeleteJobOutput, error) error
...
func nopPostDelete(_ context.Context, _ *svcapitypes.Job, _ *svcsdk.DeleteJobOutput, err error) error {
	return err
}
