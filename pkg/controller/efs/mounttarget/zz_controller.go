...
func (c *connector) Connect(ctx context.Context, mg cpresource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*svcapitypes.MountTarget)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mg cpresource.Managed) (managed.ExternalObservation, error) {
	...
	input := GenerateDescribeMountTargetsInput(cr)
	if err := e.preObserve(ctx, cr, input); err != nil {
		return managed.ExternalObservation{}, errors.Wrap(err, "pre-observe failed")
	}
	resp, err := e.client.DescribeMountTargetsWithContext(ctx, input)
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	input := GenerateCreateMountTargetInput(cr)
	if err := e.preCreate(ctx, cr, input); err != nil {
		return managed.ExternalCreation{}, errors.Wrap(err, "pre-create failed")
	}
	resp, err := e.client.CreateMountTargetWithContext(ctx, input)
	if err != nil {
	...
	if resp.AvailabilityZoneName != nil {
		cr.Status.AtProvider.AvailabilityZoneName = resp.AvailabilityZoneName
	} else {
	...
	if resp.MountTargetId != nil {
		cr.Status.AtProvider.MountTargetID = resp.MountTargetId
	} else {
		cr.Status.AtProvider.MountTargetID = nil
	}
	if resp.NetworkInterfaceId != nil {
		cr.Status.AtProvider.NetworkInterfaceID = resp.NetworkInterfaceId
	} else {
...
func (e *external) Delete(ctx context.Context, mg cpresource.Managed) error {
	...
	input := GenerateDeleteMountTargetInput(cr)
	...
	resp, err := e.client.DeleteMountTargetWithContext(ctx, input)
...
func nopPostObserve(_ context.Context, _ *svcapitypes.MountTarget, _ *svcsdk.DescribeMountTargetsOutput, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	return obs, err
}
func nopFilterList(_ *svcapitypes.MountTarget, list *svcsdk.DescribeMountTargetsOutput) *svcsdk.DescribeMountTargetsOutput {
	return list
}
...
func nopPostCreate(_ context.Context, _ *svcapitypes.MountTarget, _ *svcsdk.MountTargetDescription, cre managed.ExternalCreation, err error) (managed.ExternalCreation, error) {
	return cre, err
}
func nopPreDelete(context.Context, *svcapitypes.MountTarget, *svcsdk.DeleteMountTargetInput) (bool, error) {
	return false, nil
}
func nopPostDelete(_ context.Context, _ *svcapitypes.MountTarget, _ *svcsdk.DeleteMountTargetOutput, err error) error {
	return err
}
